...
/**
 * Plugin 'SysCategoryOrganizerFieldProvider' for the 'arc_utility' extension.
 *
 * @author	Christophe Monard <cmonard@archriss.com>
 * @package	TYPO3
 * @subpackage	arc_utility
 */
class SysCategoryOrganizerFieldProvider implements \TYPO3\CMS\Scheduler\AdditionalFieldProviderInterface {

    protected $LLL = 'LLL:EXT:arc_utility/Resources/Private/Language/locallang_syscategoryorganizer.xlf';
    ...
    public function validateAdditionalFields(array &$submittedData, \TYPO3\CMS\Scheduler\Controller\SchedulerModuleController $schedulerModule) {
        // checks
        $submittedData['pids'] = $GLOBALS['TYPO3_DB']->cleanIntList($submittedData['pids']);
        $submittedData['step'] = \TYPO3\CMS\Core\Utility\MathUtility::forceIntegerInRange($submittedData['step'], 1, 4294967295, 16); // max unsigned integer
        return TRUE;
    }
